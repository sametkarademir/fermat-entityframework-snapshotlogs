...
using Fermat.EntityFramework.SnapshotLogs.Applications.Services;
...
using Fermat.EntityFramework.SnapshotLogs.Domain.Options;
using Fermat.EntityFramework.SnapshotLogs.Infrastructure.Repositories;
using Fermat.EntityFramework.SnapshotLogs.Presentation.Controllers;
...
{
    public static IServiceCollection AddFermatSnapshotLogServices<TContext>(this IServiceCollection services, Action<SnapshotOptions> configureOptions) where TContext : DbContext
    {
